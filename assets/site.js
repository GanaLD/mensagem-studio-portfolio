...
const cfg=builder.theme||{},id=String(cfg.theme_id||DATA.theme_runtime?.active_theme?.id||'studioframe-default');document.body.dataset.sfTheme=id;return null;
};
document.documentElement.dataset.sfThemeRuntime='7.8.3';
