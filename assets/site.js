...
try{
const url=new URL('assets/motion/motion-runtime.js',hostedAssetBase()).href;
...
script.addEventListener('load',()=>window.StudioFrameThemeRuntime?.apply?.(DATA.theme_runtime||{}),{once:true});document.head.append(script);
} else window.StudioFrameThemeRuntime?.apply?.(DATA.theme_runtime||{});
return runtime;
}
