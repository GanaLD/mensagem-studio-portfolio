...
function addStyles(){
  ...
  .ms3d-shell{position:relative;width:100vw;margin-left:calc(50% - 50vw);min-height:620px;display:grid;align-items:center;perspective:1700px;perspective-origin:50% 43%;overflow:hidden;touch-action:pan-y;user-select:none}
  .ms3d-shell:before{content:"";position:absolute;left:50%;bottom:90px;width:min(72vw,980px);height:150px;transform:translateX(-50%) rotateX(78deg);border-radius:50%;background:radial-gradient(ellipse,rgba(201,255,54,.12),rgba(201,255,54,.025) 48%,transparent 72%);filter:blur(16px);pointer-events:none}
  ...
  .ms3d-card:hover,.ms3d-card:focus-visible{outline:none;--focus:1!important;border-color:rgba(201,255,54,.82);box-shadow:0 38px 110px rgba(0,0,0,.48),0 0 48px rgba(201,255,54,.24),inset 0 1px 0 rgba(255,255,255,.12)}
  .ms3d-inner{height:100%;padding:23px;display:flex;flex-direction:column;transform:translateZ(34px)}
  .ms3d-top{display:flex;align-items:center;justify-content:space-between;gap:14px}.ms3d-num{font-size:10px;letter-spacing:.16em;color:var(--lime)}
  ...
  .ms3d-copy{margin-top:auto}.ms3d-copy h3{font-size:clamp(25px,2.1vw,36px);line-height:.96;letter-spacing:-.045em;margin:0 0 11px;max-width:10ch}.ms3d-copy p{margin:0;color:var(--muted);line-height:1.45;font-size:12.5px;max-width:31ch}
  .ms3d-foot{margin-top:18px;padding-top:13px;border-top:1px solid rgba(255,255,255,.1);display:flex;justify-content:space-between;gap:16px;align-items:center;font-size:9px;letter-spacing:.12em;text-transform:uppercase;color:#d9ddd0}.ms3d-foot b{color:var(--lime)}
  .ms3d-edge{position:absolute;top:50%;z-index:50;transform:translateY(-50%);width:58px;height:58px;border-radius:50%;border:1px solid rgba(201,255,54,.5);background:rgba(7,8,6,.48);backdrop-filter:blur(12px);color:var(--lime);font-size:30px;display:grid;place-items:center;cursor:pointer;box-shadow:0 0 24px rgba(201,255,54,.09);transition:.2s ease}
  .ms3d-edge:hover,.ms3d-edge:focus-visible{outline:none;background:var(--lime);color:#080a05;transform:translateY(-50%) scale(1.05);box-shadow:0 0 34px rgba(201,255,54,.24)}
  .ms3d-edge.prev{left:clamp(12px,2vw,34px)}.ms3d-edge.next{right:clamp(12px,2vw,34px)}
  .ms3d-meta{position:absolute;left:50%;bottom:28px;z-index:32;transform:translateX(-50%);display:flex;align-items:center;gap:14px;color:#7f8779;font-size:9px;letter-spacing:.14em;text-transform:uppercase;white-space:nowrap;pointer-events:none}.ms3d-status{color:#a9b09f}
  ...
  @media(max-width:1024px){.ms3d-shell{min-height:570px;perspective:1450px}.ms3d-stage{height:410px}.ms3d-card{width:226px;height:300px;margin-left:-113px;margin-top:-150px}.ms3d-inner{padding:21px}.ms3d-edge{width:52px;height:52px}.brief-grid{grid-template-columns:1fr!important}}
  @media(max-width:760px){.ms3d-shell{min-height:520px;perspective:1100px}.ms3d-shell:after{background:linear-gradient(90deg,#070806 0,transparent 4%,transparent 96%,#070806 100%)}.ms3d-stage{height:370px}.ms3d-card{width:198px;height:276px;margin-left:-99px;margin-top:-138px;border-radius:21px}.ms3d-inner{padding:18px}.ms3d-copy h3{font-size:26px}.ms3d-copy p{font-size:11.5px}.ms3d-edge{width:44px;height:44px;font-size:24px}.ms3d-edge.prev{left:8px}.ms3d-edge.next{right:8px}.ms3d-meta{bottom:20px;font-size:8px}.video-scroll-label{left:16px!important;right:16px;bottom:38px!important;font-size:10.5px!important;line-height:1.35}.video-scroll-meter{left:16px!important;right:16px!important}.ms-brief-action{min-height:72px;padding:0 18px}.ms-footer-links{display:grid;grid-template-columns:1fr 1fr}.ms-footer-link{width:100%}.ms-footer-meta{flex-direction:column}.stage-side{max-width:calc(100vw - 32px);overflow:auto}#motion .stage-side{left:16px;right:16px}#motion .stage-note{right:16px}#msHomeWhatsapp{width:54px!important;height:54px!important;min-height:54px!important;right:16px!important;bottom:16px!important}}
  @media(prefers-reduced-motion:reduce){.video-scroll-label,.video-scroll-meter i:after{animation:none!important}.ms3d-card,.ms3d-edge,.ms-brief-action{transition:none!important}}
  `;
