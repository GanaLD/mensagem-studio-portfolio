...
(() => {
  ...
  const VERSION = '20260921-r29-metal-button-faithful';
  ...
  if(!document.querySelector('link[data-ms-metal-button]')){
    ...
    metalCss.href=ROOT+'assets/ms-metal-button-v1.css?v=20260921-metal-faithful-1';
  ...
  if(!document.querySelector('script[data-ms-metal-button]')){
    ...
    metalJs.type='module';
    metalJs.src=ROOT+'assets/ms-metal-button-v1.js?v=20260921-metal-faithful-1';
