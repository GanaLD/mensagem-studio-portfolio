...
(() => {
  ...
  const VERSION = '20260921-r28-metal-button-3d-safe';
  ...
  if(!document.querySelector('link[data-ms-metal-button]')){
    ...
    metalCss.href=ROOT+'assets/ms-metal-button-v1.css?v=20260921-3d-safe-3';
  ...
  if(!document.querySelector('script[data-ms-metal-button]')){
    ...
    metalJs.type='module';
    metalJs.src=ROOT+'assets/ms-metal-button-v1.js?v=20260921-3d-safe-3';
