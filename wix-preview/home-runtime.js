...
function addStyles(){
  ...
  .ms3d-top{display:flex;align-items:center;justify-content:space-between;gap:12px}.ms3d-num{font-size:9px;letter-spacing:.16em;color:var(--ms3d-card-blue);text-shadow:0 0 12px rgba(var(--ms3d-card-blue-rgb),.42)}
  ...
  .ms3d-foot{margin-top:14px;padding-top:11px;border-top:1px solid rgba(255,255,255,.14);display:flex;justify-content:space-between;gap:12px;align-items:center;font-size:8px;letter-spacing:.12em;text-transform:uppercase;color:#e1e1d7}.ms3d-foot b{color:var(--ms3d-card-blue);text-shadow:0 0 12px rgba(var(--ms3d-card-blue-rgb),.34)}
