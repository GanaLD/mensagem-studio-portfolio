...
function upgradeServicesBorderGlowPreview(){
  const cards=[...document.querySelectorAll('#msServicesDeck .ms3d-card')];
  if(!cards.length||document.querySelector('#ms-preview-border-glow-style')) return;
  ...
  .ms3d-card.ms-border-glow-preview{
    ...
    background:
      linear-gradient(145deg,rgba(255,255,255,.115),rgba(255,255,255,.035) 30%,rgba(25,36,58,.17) 68%,rgba(65,105,225,.075)),
      rgba(5,9,15,.22)!important;
    -webkit-backdrop-filter:blur(30px) saturate(145%) contrast(1.03)!important;
    backdrop-filter:blur(30px) saturate(145%) contrast(1.03)!important;
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.22),
      inset 0 -1px 0 rgba(255,255,255,.035),
      0 22px 70px rgba(0,0,0,.30),
      0 0 24px rgba(65,105,225,.07)!important;
  }
  .ms3d-card.ms-border-glow-preview .ms3d-inner{
    position:relative;
    z-index:4;
  ...
  .ms3d-card.ms-border-glow-preview > .ms-border-edge-light{
    content:"";
    position:absolute;
    inset:0;
  ...
  .ms3d-card.ms-border-glow-preview::before{
    ...
    background:
      linear-gradient(rgba(8,12,19,.08) 0 100%) padding-box,
      radial-gradient(at 80% 55%,rgba(255,255,255,.98) 0,transparent 50%) border-box,
      radial-gradient(at 69% 34%,rgba(91,121,255,.92) 0,transparent 50%) border-box,
      radial-gradient(at 8% 6%,rgba(143,255,216,.82) 0,transparent 50%) border-box,
      radial-gradient(at 41% 38%,rgba(201,255,54,.76) 0,transparent 50%) border-box,
      radial-gradient(at 86% 85%,rgba(111,143,255,.84) 0,transparent 50%) border-box,
      radial-gradient(at 82% 18%,rgba(255,225,120,.94) 0,transparent 50%) border-box,
      linear-gradient(rgba(255,255,255,.75) 0 100%) border-box;
    opacity:calc((var(--edge-proximity) - var(--color-sensitivity))/(100 - var(--color-sensitivity)));
    -webkit-mask-image:conic-gradient(from var(--cursor-angle) at center,#000 calc(var(--cone-spread)*1%),transparent calc((var(--cone-spread) + 15)*1%),transparent calc((100 - var(--cone-spread) - 15)*1%),#000 calc((100 - var(--cone-spread))*1%));
    mask-image:conic-gradient(from var(--cursor-angle) at center,#000 calc(var(--cone-spread)*1%),transparent calc((var(--cone-spread) + 15)*1%),transparent calc((100 - var(--cone-spread) - 15)*1%),#000 calc((100 - var(--cone-spread))*1%));
  }
  .ms3d-card.ms-border-glow-preview::after{
    z-index:2;
    border:1px solid transparent;
    background:
      radial-gradient(at 80% 55%,rgba(255,255,255,.24) 0,transparent 50%) padding-box,
      radial-gradient(at 69% 34%,rgba(91,121,255,.18) 0,transparent 50%) padding-box,
      radial-gradient(at 8% 6%,rgba(143,255,216,.14) 0,transparent 50%) padding-box,
      radial-gradient(at 41% 38%,rgba(201,255,54,.10) 0,transparent 50%) padding-box,
      radial-gradient(at 86% 85%,rgba(111,143,255,.16) 0,transparent 50%) padding-box,
      radial-gradient(at 82% 18%,rgba(255,225,120,.14) 0,transparent 50%) padding-box;
    opacity:calc(var(--fill-opacity)*(var(--edge-proximity) - var(--color-sensitivity))/(100 - var(--color-sensitivity)));
    mix-blend-mode:screen;
    -webkit-mask-image:
      linear-gradient(to bottom,#000,#000),
      radial-gradient(ellipse at 50% 50%,#000 40%,transparent 67%),
  ...
  .ms3d-card.ms-border-glow-preview > .ms-border-edge-light::before{
    content:"";
    position:absolute;
    inset:var(--glow-padding);
    border-radius:inherit;
    box-shadow:
      inset 0 0 0 1px hsl(49deg 100% 88% / 100%),
      inset 0 0 3px hsl(49deg 100% 88% / 52%),
      inset 0 0 8px hsl(49deg 100% 88% / 35%),
      inset 0 0 20px hsl(49deg 100% 88% / 20%),
      0 0 2px hsl(49deg 100% 88% / 70%),
      0 0 8px hsl(49deg 100% 88% / 42%),
      0 0 22px hsl(49deg 100% 88% / 24%),
      0 0 46px rgba(91,121,255,.16);
  }
  .ms3d-card.ms-border-glow-preview:not(:hover):not(:focus-visible)::before,
  .ms3d-card.ms-border-glow-preview:not(:hover):not(:focus-visible)::after,
  .ms3d-card.ms-border-glow-preview:not(:hover):not(:focus-visible) > .ms-border-edge-light{
    opacity:0;
    transition:opacity .65s ease-in-out;
  }
  .ms3d-card.ms-border-glow-preview:hover,
  .ms3d-card.ms-border-glow-preview:focus-visible{
    border-color:rgba(255,255,255,.24)!important;
    background:
      linear-gradient(145deg,rgba(255,255,255,.145),rgba(255,255,255,.045) 30%,rgba(31,45,72,.19) 68%,rgba(65,105,225,.09)),
      rgba(5,9,15,.24)!important;
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.28),
      inset 0 -1px 0 rgba(255,255,255,.045),
      0 28px 80px rgba(0,0,0,.34),
      0 0 32px rgba(65,105,225,.10)!important;
  }
  @media(hover:none){
    .ms3d-card.ms-border-glow-preview{
      background:
        linear-gradient(145deg,rgba(255,255,255,.12),rgba(255,255,255,.035) 34%,rgba(26,38,61,.18) 72%,rgba(65,105,225,.08)),
        rgba(5,9,15,.23)!important;
      border-color:rgba(255,255,255,.18)!important;
    }
    .ms3d-card.ms-border-glow-preview::before,
    .ms3d-card.ms-border-glow-preview::after,
    .ms3d-card.ms-border-glow-preview > .ms-border-edge-light{display:none!important}
  }
  ...
  cards.forEach(card=>{
    card.classList.add('ms-border-glow-preview');
    if(!card.querySelector(':scope > .ms-border-edge-light')){
      const light=document.createElement('span');
      light.className='ms-border-edge-light';
      light.setAttribute('aria-hidden','true');
      card.prepend(light);
    }
    card.addEventListener('pointermove',e=>setFromPointer(card,e),{passive:true});
    card.addEventListener('pointerleave',()=>card.style.setProperty('--edge-proximity','0'),{passive:true});
    card.addEventListener('focus',()=>{
      card.style.setProperty('--edge-proximity','100');
      card.style.setProperty('--cursor-angle','45deg');
    });
    card.addEventListener('blur',()=>card.style.setProperty('--edge-proximity','0'));
  });
}

function init(){addStyles();upgradeServices();upgradeServicesBorderGlowPreview();upgradeMotion();upgradeBrief();upgradeFooter();upgradeWhatsapp()}
